...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://instagram-backend-my27.onrender.com/api/v1/post/${post?._id}/${action}`, { withCredentials: true });
    ...
    const commentHandler = async () => {
        ...
        try {
            const res = await axios.post(`https://instagram-backend-my27.onrender.com/api/v1/post/${post?._id}/comment`, { text }, {
                headers: {
                    'Content-Type': 'application/json'
                },
                withCredentials: true
    ...
    const deletePostHandler = async () => {
        try {
            const res = await axios.delete(`https://instagram-backend-my27.onrender.com/api/v1/post/delete/${post?._id}`, { withCredentials: true })
            if (res.data.success) {
            ...
            console.log(error);
            toaster.error(error.response.data.messsage);
        }
    }

    const bookmarkHandler = async () => {
        try {
            const res = await axios.get(`https://instagram-backend-my27.onrender.com/api/v1/post/${post?._id}/bookmark`, { withCredentials: true });
            if (res.data.success) {
